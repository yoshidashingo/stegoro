...
- `./rule-details/analysis/` — A1: rfp-intake, A2: requirements-extraction, A3: compliance-matrix
- `./rule-details/planning/` — P1: proposal-structure-design, P2: win-strategy, P3: content-planning
- `./rule-details/writing/` — W1: executive-summary, W2: technical-response, W3: management-response, W4: pricing-framework
- `./rule-details/review/` — R1: compliance-check, R2: quality-review, R3: final-assembly
- `./rule-details/common/` — process-overview, content-validation, overconfidence-prevention 他
