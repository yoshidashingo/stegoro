...
|-------|-------------|-----------|
| **Customer Support Agent** | Customer ticket triage, response, and quality review | `.customer-support-agent/` |
| **Proposal Writer** | RFP analysis and proposal creation | `.proposal-writer/` |
| **Sales Pipeline Agent** | Sales pipeline management with cycle-based workflow | `.sales-pipeline-agent/` |
